...
function sizePool(pool, node) {
  ...
  pool.resize(pool.getBBox().width - labelWidth, pool.getBBox().height - labelWidth);
  pool.resize(pool.getBBox().width, pool.getBBox().height - labelWidth, { direction: "top" });
