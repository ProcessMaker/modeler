...
import icon from '@/assets/toolpanel/generic-intermediate-event.svg';
import { defaultDurationTimerEvent } from '@/constants';
import intermediateCatchTimerEventIcon from '@/assets/toolpanel/intermediate-timer-event.svg';
import intermediateSignalCatchEventIcon from '@/assets/toolpanel/intermediate-signal-catch-event.svg';
import intermediateSignalThrowEventIcon from '@/assets/toolpanel/intermediate-signal-throw-event.svg';
import intermediateMessageCatchEventIcon from '@/assets/toolpanel/intermediate-message-catch-event.svg';
import intermediateMessageThrowEventIcon from '@/assets/toolpanel/intermediate-message-throw-event.svg';
import intermediateConditionalCatchEventIcon from '@/assets/toolpanel/intermediate-conditional-catch-event.svg';
