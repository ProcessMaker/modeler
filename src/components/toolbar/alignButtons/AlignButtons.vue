...
import distributeHorizontallyIcon from '@/assets/distribute-horizontally-icon.svg?url';
import distributeVerticallyIcon from '@/assets/distribute-vertically-icon.svg?url';
