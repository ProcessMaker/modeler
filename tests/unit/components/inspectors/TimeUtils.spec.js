...
describe("TimeUtils", () => {
  describe("Iso8601 Formatted Cycle Strings", () => {
    ...
    it("it formats weekly cycle that repeats indefinitely correctly", () => {
      ...
      expect(getIso8601FormattedDateString(startDate, null, period, ends, null)).toBe(expected);
    });
    ...
    it("it formats weekly cycle that ends after 10 weeks correctly", () => {
      ...
      expect(getIso8601FormattedDateString(startDate, null, period, ends, times)).toBe(expected);
    });
    ...
    it("it formats weekly cycle that ends a specific date correctly", () => {
      ...
      expect(getIso8601FormattedDateString(startDate, endDate, period, ends, null)).toBe(expected);
    });
  });
