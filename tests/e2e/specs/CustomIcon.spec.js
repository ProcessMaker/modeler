import { addNodeTypeToPaper, dragFromSourceToDest, getElementAtPosition } from "../support/utils";
...
describe("customIcon", () => {
  ...
  [nodeTypes.task, nodeTypes.manualTask, nodeTypes.scriptTask].forEach((taskType) => {
  ...
  it("can set custom icon for Form Task", () => {
    ...
    cy.get('[data-test="nodeIcon"]').should("have.attr", "xlink:href").and("equal", searchPlusSvg);
  });
});
