...
describe('Multiselect', () => {
  it('should move multiple shapes when shift+clicking to highlight and dragging', () => {
  ...
  it('should move multiple shapes when shift+clicking to highlight and using arrow keys', () => {
    const task1Position = { x: 100, y: 100 };
    const task2Position = { x: task1Position.x + 100, y: task1Position.y + 100 };
