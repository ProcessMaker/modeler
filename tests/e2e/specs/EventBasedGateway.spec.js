...
describe("Event-Based Gateway", () => {
  ...
  it("When convert to Event Based Gateway it should not have the property default", () => {
    ...
    const updatedSequenceFlow =
      '<bpmn:eventBasedGateway id="node_3" name="Event Based Gateway"><bpmn:incoming>node_7</bpmn:incoming><bpmn:outgoing>node_9</bpmn:outgoing><bpmn:outgoing>node_11</bpmn:outgoing></bpmn:eventBasedGateway>';
